...
function Contact() {
  ...
  return (
    <div className="w-screen max-w-xs flex justify-center m-auto p-4" >
      ...
      <form onSubmit={onSubmit}>
            ...
            <textarea className='px-10 border-gray border-t border-b' placeholder='Message' name="message"></textarea>
